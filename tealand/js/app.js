(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".body-gallery__slider")) new swiper_core_Swiper(".body-gallery__slider", {
    ...
    da.init();
    let swiperSlide = document.querySelectorAll(".hero__slider");
    swiperSlide.forEach((function(container, index) {
        container.classList.add("swiper-slide" + index);
        container.dataset.dragSize && parseFloat(container.dataset.dragSize);
        container.dataset.freeMode && container.dataset.freeMode;
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
