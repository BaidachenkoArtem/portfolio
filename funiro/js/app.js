(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-tips")) new swiper_core_Swiper(".slider-tips", {
...
***************************************************************************** */
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (spollerButtons.length > 0) spollerButtons.forEach((button => {
            button.addEventListener("click", (function(e) {
                const parentItem = this.closest(".menu__item");
                const subMenu = parentItem.querySelector(".menu__sub-menu");
                if (subMenu) {
        ...
        function closeAllSubMenus() {
            document.querySelectorAll(".menu__item._active").forEach((item => {
                ...
                item.querySelector(".menu__sub-menu").style.maxHeight = null;
            }));
        }
    ...
    window.onload = function() {
        ...
        function updateCart(productButton, productId, productAdd = true) {
            ...
            if (productAdd) {
                ...
                if (!cartProduct) {
                    const product = document.querySelector(`[data-pid="${productId}"]`);
                    const cartProductImageSrc = product.querySelector(".item-product__image").getAttribute("src");
                    const cartProductTitle = product.querySelector(".item-product__title").innerHTML;
                    const cartProductContent = `\n\t\t\t\t<a href="" class="cart-list__link">\n\t\t\t\t\t<img class="cart-list__image ibg" src="${cartProductImageSrc}" alt="Image">\n\t\t\t\t</a>\n\t\t\t\t<div class="cart-list__body">\n\t\t\t\t\t<a href="" class="cart-list__title">${cartProductTitle}</a>\n\t\t\t\t\t<div class="cart-list__quantity">Quantity: <span>1</span></div>\n\t\t\t\t\t<a href="" class="cart-list__delete">Delete</a>\n\t\t\t\t</div>`;
