    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main__slider")) {
                let k = new swiper_core_Swiper(".main__slider", {
                ...
                k.on("slideChange", (function(e) {
                    const a = e.activeIndex + 1;
                    document.querySelector(".main__item");
                    const b = document.getElementById("1"), c = document.getElementById("2"), d = document.getElementById("3"), f = document.getElementById("4"), g = document.getElementById("5"), h = document.querySelector(".swiper-slide");
                    h.setAttribute("data-swiper-slide-index", a), h.getAttribute("data-swiper-slide-index") == b.id ? b.classList.add("active") : b.classList.remove("active"), 
                    h.getAttribute("data-swiper-slide-index") == c.id ? c.classList.add("active") : c.classList.remove("active"), 
                    h.getAttribute("data-swiper-slide-index") == d.id ? d.classList.add("active") : d.classList.remove("active"), 
                    h.getAttribute("data-swiper-slide-index") == f.id ? f.classList.add("active") : f.classList.remove("active"), 
                    h.getAttribute("data-swiper-slide-index") == g.id ? g.classList.add("active") : g.classList.remove("active");
                }));
            }
