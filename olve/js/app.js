(() => {
    ...
    da.init();
    const gallery = document.querySelector(".testimonial");
    if (gallery && !isMobile.any()) window.addEventListener("scroll", (function(e) {
        const gWidth = gallery.offsetWidth;
        const gRow = document.querySelectorAll(".testimonial__row");
        const wHeight = window.innerHeight;
        gRow.forEach(((gRowItem, index) => {
            const gItems = gRowItem.querySelectorAll(".item-testimonial");
            let dRowWidth = 0;
