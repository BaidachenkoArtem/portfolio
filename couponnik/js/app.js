(() => {
    ...
    function initSliders() {
        if (document.querySelector(".body-single__slider")) new swiper_core_Swiper(".body-single__slider", {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const box = document.querySelector(".up-2");
        const footer = document.querySelector(".footer");
        function checkVisibility() {
            const footerRect = footer.getBoundingClientRect();
            const footerVisible = footerRect.top < window.innerHeight && footerRect.bottom >= 0;
            if (footerVisible) box.classList.add("hidden"); else box.classList.remove("hidden");
        }
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const suggestions1 = document.getElementById("sugquestionsList1");
        const suggestionsList1 = [ "Natural ionikon", "Natural ionikon Kilokoa", "Natural ionikon Kilokoa" ];
        searchInput1.addEventListener("input", (function() {
            const inputValue1 = searchInput1.value.toLowerCase();
            suggestions1.innerHTML = "";
            if (inputValue1) {
                const filteredSuggestions1 = suggestionsList1.filter((suggestion => suggestion.toLowerCase().includes(inputValue1)));
                filteredSuggestions1.forEach((suggestion => {
                    ...
                    suggestions1.appendChild(li1);
                }));
            }
        }));
        const searchInput2 = document.getElementById("searchInput2");
        const suggestionsContainer2 = document.getElementById("sugquestionsList2");
        const suggestionsList2 = [ {
            img: "img/home/question-list/eBay.jpg",
            name: "eBay",
            coupons: "2 Available Coupons",
            link: "#"
        }, {
            img: "img/home/question-list/belle.jpg",
            name: "Belle",
            coupons: "2 Available Coupons",
            link: "#"
        }, {
            img: "img/home/question-list/dyson.jpg",
            name: "Dyson",
            coupons: "2 Available Coupons",
            link: "#"
        }, {
            img: "img/home/question-list/starbucks.jpg",
            name: "Starbucks",
            coupons: "2 Available Coupons",
            link: "#"
        }, {
            img: "img/home/question-list/mcDonalds.jpg",
            name: "McDonald's",
            coupons: "2 Available Coupons",
            link: "#"
        } ];
        searchInput2.addEventListener("input", (function() {
            const inputValue2 = searchInput2.value.toLowerCase();
            suggestionsContainer2.innerHTML = "";
            if (inputValue2) {
                const filteredSuggestions2 = suggestionsList2.filter((suggestion => suggestion.name.toLowerCase().includes(inputValue2)));
                filteredSuggestions2.forEach((suggestion => {
                    const suggestionItem = document.createElement("div");
                    suggestionItem.classList.add("sugquestions__item");
                    suggestionItem.innerHTML = `\n\t\t\t\t\t<img src="${suggestion.img}" alt="${suggestion.name}">\n\t\t\t\t\t<div class="sugquestions__details details-sugquestions">\n\t\t\t\t\t\t<p>${suggestion.name}</p>\n\t\t\t\t\t\t<span>${suggestion.coupons}</span>\n\t\t\t\t\t</div>\n\t\t\t\t\t<a href="${suggestion.link}" class="sugquestions__read-more">Read More</a>\n\t\t\t\t`;
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        document.addEventListener("click", (function() {
            if (languageDropdown.style.display === "block") languageDropdown.style.display = "none";
        }));
        ...
        languageOptions.forEach((option => {
            option.addEventListener("click", (function() {
                ...
                languageBtn.querySelector("img").src = flagImg;
